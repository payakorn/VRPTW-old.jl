...
export load_solomon_data, dir, dir_data, Solution, Problem, swap!, add!, push!, splice!, empty_solution, C1, C2, R1, R2, RC1, RC2, fix_route_zero, route_length, distance, opt_balancing, find_opt, show_opt_solution, dict_to_solution, load_solution,
	...
	simulated_annealing_run, find_best_solution_of_SA, create_simulated_annealing_summary, load_solution_phase0, find_best_known, combine_best_known, balancing_value, save_solution_struct, write_solution_txt, load_solution_SA, seperate_route_to_array,
	sent_email, opt_balancing_weighted_sum, balancing_value_weighted_sum, balancing_value_weighted_sum_w2_w8, balancing_value_weighted_sum_w1_w9, balancing_value_weighted_sum_w3_w7, balancing_value_weighted_sum_w4_w6
