...
date_now = now()
print("start program $(Dates.format(date_now, "e, d u yyyy H:M:S"))")
...
date_finish = now()
print("End Time: $(Dates.format(date_now, "e, d u yyyy H:M:S"))")